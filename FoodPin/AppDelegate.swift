...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        UINavigationBar.appearance().barTintColor = UIColor(red: 51.0/255.0, green: 110.0/255.0, blue: 123.0/255.0, alpha: 1.0)
        
        UIApplication.shared.statusBarStyle = .lightContent  //allows status bar text to be white
        
        UITabBar.appearance().barTintColor = UIColor(red: 236.0/255.0, green: 240.0/255.0, blue: 241.0/255.0, alpha: 1.0)
        
        if let barFont = UIFont(name: "AvenirNext-Medium", size: 24.0){
